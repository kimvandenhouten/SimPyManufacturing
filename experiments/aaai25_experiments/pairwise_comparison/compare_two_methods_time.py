...
print(data["time_offline"].tolist())
...
for problem in data['instance_folder'].unique():
    ...
    for (method1, method2) in method_pairs:
        ...
        res = wilcoxon(data1_at_least_one_feasible['time_offline'], data2_at_least_one_feasible['time_offline'], method="approx")
        ...
        res = wilcoxon(data1_double_hits['time_offline'], data2_double_hits['time_offline'], method="approx")
        stat_obj = res.statistic
        p_obj = res.pvalue
        z_obj = res.zstatistic
        print(f'stat_obj: {stat_obj}, p_obj is {p_obj}, z_obj is {z_obj}')
