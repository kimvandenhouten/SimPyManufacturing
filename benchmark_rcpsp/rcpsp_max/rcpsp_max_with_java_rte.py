...
data = []
results_location = "rcpsp_max_results_java"
nr_samples = 2
instance_folder = "j10"
                ...
                if schedule:
                    ...
                    if check_feasibility:
                        ...
                        data.append({"instance": f"{instance_folder}/PSP{instance_id}",
                                     "status": "feasible_and_dc", "sample": sample, "rcpsp/max_feasible": True, "makespan_rte_star": makespan_rte_star})
                        data_df = pd.DataFrame(data=data)
                        data_df.to_csv(f"benchmark_rcpsp/rcpsp_max/{results_location}.csv")
