...
for seed in range(0, 200):
    ...
    print(f'makespan obtained by simulation is {makespan}')
    if nr_unfinished > 0:
        print('WARNING: not all products finished')
    ...
    _, _, cp_output = rcpsp.solve(60, 1, 0)
    makespan_cp_output = max(cp_output["end"].tolist())
    print(f'makespan under perfect information is {makespan_cp_output}\n')
