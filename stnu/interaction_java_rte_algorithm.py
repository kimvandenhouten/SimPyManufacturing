...
for (file_name, dc) in file_list:
    instance_location = os.path.abspath(f"stnu/java_comparison/xml_files/{file_name}.stnu")
...
stnu = STNU.from_graphml(f"stnu/java_comparison/xml_files/{file_name}-output.stnu")
