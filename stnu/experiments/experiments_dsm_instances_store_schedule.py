            ...
            if res:
                ...
                if dc:
                    ...
                    for i in range(n_sim):
                        ...
                        schedule_csv = []
                        for i in rte_data.f:
                            schedule_csv.append({"i": i,
                                                 "description": estnu.translation_dict[i],
                                                 "assignment": rte_data.f[i]})
                        schedule_pd = pd.DataFrame(schedule_csv)
                        schedule_pd.to_csv(f'stnu/experiments/results/schedule_rte_{instance_size}_{instance_id}_{instance_type}.csv')

                        print(estnu.translation_dict)
                        ...
                        print(cp_output)
                        cp_output.to_csv(f'stnu/experiments/results/schedule_pf_type={instance_type}_{instance_size}_{instance_id}.csv', index=False)
                        ...
                        collected_data_df.to_csv(f'stnu/experiments/results_DSM_instances.csv')
                else:
