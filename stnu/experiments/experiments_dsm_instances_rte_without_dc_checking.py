...
collected_data = []
n_sim = 10
results_location = f'stnu/experiments/results/results_DSM_instances_without_dc_checking.csv'
        ...
        for instance_type in [1, 2]:
            ...
            if res:
                ...
                for i in range(n_sim):
                    ...
                    sample = {}
                    for (A, C) in stnu.contingent_links:
                        duration_sample = np.random.randint(stnu.contingent_links[(A, C)]["lc_value"],
                                                            stnu.contingent_links[(A, C)]["uc_value"])
                    ...
                    if rte_data:
                        ...
                        for product in my_productionplan.products:
                            for activity in product.activities:
                                ...
                                node_idx_start = stnu.translation_dict_reversed[key_start]
                                node_idx_finish = stnu.translation_dict_reversed[key_finish]
                        ...
                        collected_data.append({"instance": instance_name, "it": i,  "makespan_lb": makespan_pi, "gap_lb": gap_pi , "makespan_stnu": makespan_stnu,
                                              ...
                                              "instance_type": instance_type, "status": "rte_success"})
                        ...
                        logger.info(f'RTE* could not finish')
