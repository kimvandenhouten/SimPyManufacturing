...
stnu_to_xml(stnu, "slide_118", "stnu/java_comparison/xml_files")
...
stnu_to_xml(stnu, "hunsberger'23", "stnu/java_comparison/xml_files")
...
stnu_to_xml(stnu, "morris'14", "stnu/java_comparison/xml_files")
