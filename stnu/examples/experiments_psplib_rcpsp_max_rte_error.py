...
sample_mode = "sample"
data = []
results_location = "stnu/experiments/results/debugging_j10_random_oracle_python_rte_error.csv"
nr_samples = 1
for instance_folder in ["j10"]:
    for instance_id in [138]:
                ...
                for i in range(nr_samples):
                    ...
                    if rte_data:
                        ...
                        data.append({"instance_name": f'{instance_folder}_PSP_{instance_id}',
                                     ...
                                     "schedule_feasibility": check_feasibility})
