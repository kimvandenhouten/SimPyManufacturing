...
class RCPSP_CP:
    def __init__(self, instance):
        ...
        for constraint in instance.factory.compatibility_constraints:
            ...
            indices_1 = (translation_table[(translation_table['product_id'] == p1) & (
                        translation_table['activity_id'] == a1)].index.tolist())
            indices_2 = (translation_table[(translation_table['product_id'] == p2) & (
                        translation_table['activity_id'] == a2)].index.tolist())
