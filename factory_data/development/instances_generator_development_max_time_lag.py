...
for p in factory.products:
    for t in p.temporal_relations:
        p.temporal_relations[t].max_lag = p.temporal_relations[t].min_lag + 2
...
for instance_size in [10, 20, 40, 60, 120, 240]:
    for id in range(1, 11):
        ...
        file_name = f'factory_data/development/instances_type_2/instance_{plan.name}.json'
