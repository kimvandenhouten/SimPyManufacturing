...
class Simulator:
    ...
    def product(self, p, priority):
            ...
            for r in range(0, self.NR_RESOURCES):
                ...
                if need > 0:
                    for _ in range(0, need):
                        ...
                        resources_required.append(resource.request(priority=priority))
        ...
        if self.printing:
            print(f'activity: {p} retrieved resources: {resources_names} at time: {start_time}')
        ...
        if self.printing:
            print(f'activity: {p} released resources: {resources_names} at time: {end_time}')
        for resource_name in resources_names:
            self.resource_usage.append({"Activity": p,
                                        "Product": p,
